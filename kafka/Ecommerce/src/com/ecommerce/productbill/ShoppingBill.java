package com.ecommerce.productbill;
...
{  
    public static void main(String args[])   
        {  
            ...
            System.out.println("\t\t\t\t\t "+"  "+"Indimart Ecommerce");  
            System.out.println("\t\t\t\t\t3/85 shaniwar peth pune");  
            System.out.println("\t\t\t\t\t"  +"    " +"Bajirao road shivajinager");  
            System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+91) 8855827843");  
